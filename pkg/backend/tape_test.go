...
func TestTapeChunked(t *testing.T) {
...
func TestTapeArbitrary(t *testing.T) {
	chunks.TestArbitraryReadWriterAtGeneric(
		t,
		func(chunkSize, chunkCount int64) (chunks.ReadWriterAt, func() error, error) {
			size := int64(chunkCount) * int64(chunkSize)
			...
			return chunks.NewArbitraryReadWriterAt(
